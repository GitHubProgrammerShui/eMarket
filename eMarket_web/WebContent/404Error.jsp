...
.logo,.tower,.cruise{background:url(errors/404error/images/un_pic.png) no-repeat;}
.wrap{background:#1158e7 url(errors/404error/images/404_bg.jpg) no-repeat center bottom;width:100%;overflow:hidden;}
...
.wave1{position:relative;z-index:3;width:100%;margin-top:-220px;color:#999;background:url(errors/404error/images/bl.png) repeat-x 0 0;-webkit-animation:8s linear 0s none infinite tweenxx;-moz-animation:8s linear 0s none infinite tweenxx;animation:8s linear 0s none infinite tweenxx;}
.wave{height:220px;background:url(errors/404error/images/bl.png) repeat-x 330px 0;-webkit-animation:10s linear 0s none infinite tweenx;-moz-animation:10s linear 0s none infinite tweenx;animation:10s linear 0s none infinite tweenx;}
...
<body>
	<div class="wrap">
		<div class="content">
			<a href="index。jsp"><h1 class="logo">e家电脑</h1></a>
			
			<div class="errorinfo">
				<p>人难免会迷失自我，但好在我们有您。</p>
				<a class="goback" href="${pageContext.request.contextPath}/index.jsp">返回首页</a>				
			</div>
			<div class="miscbox">
				<div class="tower"></div>
