...
function CalendarInit()    ///Create panel
{
 ...
 htmlAll="<div  align='center' id='"+this.sDIVID+"' style='display:none;position:absolute;width:210px;border:"+this.divBorderCss+";padding:2px;background-color:#FFFFFF'>";
 htmlAll+="<div align='center'>";
 /// Month
 htmloMonth="<select id='"+this.sMONTHID+"' onchange=CalendarMonthChange("+this.instanceName+") >";
 for(i=0;i<12;i++)
 {   
 ...
 htmloMonth+="</select>&nbsp;&nbsp;";
 /// Year
 htmloYear="&nbsp;&nbsp;&nbsp;<select id='"+this.sYEARID+"' onchange=CalendarYearChange("+this.instanceName+") >";
 ...
 /// Day
 htmloDayTable="<table id='"+this.sTABLEID+"' width='97%' border=0 cellpadding=0 cellspacing=1 bgcolor='"+this.tableBorderColor+"'>";
